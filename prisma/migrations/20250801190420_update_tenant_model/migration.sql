...
-- AlterTable
ALTER TABLE "public"."tenant" DROP COLUMN "first_name",
...
-- AddForeignKey
ALTER TABLE "public"."users_tenants" ADD CONSTRAINT "users_tenants_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."users_tenants" ADD CONSTRAINT "users_tenants_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
