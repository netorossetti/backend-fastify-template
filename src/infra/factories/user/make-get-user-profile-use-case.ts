import { GetUserProfileUseCase } from "src/domain/application/use-cases/user/get-user-profile-use-case.js";
...
export function makeGetUserProfileUseCase() {
  ...
  return new GetUserProfileUseCase(usersRepository, membershipsRepository, tenantsRepository);
}
