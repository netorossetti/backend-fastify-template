import { ListUserAccessUseCase } from "src/domain/application/use-cases/membership/list-user-access-use-case.js";
...
export function makeListUserAccessUseCase() {
  ...
  return new ListUserAccessUseCase(usersRepository, tenantsRepository, membershipsRepository);
}
