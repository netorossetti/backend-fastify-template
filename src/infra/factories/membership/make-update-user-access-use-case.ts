import { UpdateUserAccessUseCase } from "src/domain/application/use-cases/membership/update-user-access-use-case.js";
...
export function makeUpdateUserAccessUseCase() {
  ...
  return new UpdateUserAccessUseCase(usersRepository, tenantsRepository, membershipsRepository);
}
