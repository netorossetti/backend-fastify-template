import { ReactivateTenantUseCase } from "src/domain/application/use-cases/tenant/reactivate-tenant-use-case.js";
...
export function makeReactivateTenantUseCase() {
  ...
  return new ReactivateTenantUseCase(usersRepository, tenantsRepository, membershipsRepository);
}
